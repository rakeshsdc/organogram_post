...
POS_HEADERS = ["position_id", "position_title", "name", "department", "reports_to",
               "status", "email", "phone", "sort_order", "reports_to_title (auto - do not type)"]
POS_WIDTHS = [12, 30, 22, 20, 12, 10, 26, 16, 11, 34]

positions = [
    ("P001", "Director", "Dr. Anil Kumar", "Administration", "", "Filled", "director@example.org", "9800000001", 1),
    ("P002", "Deputy Director", "Ms. Bina Thomas", "Administration", "P001", "Filled", "", "", 1),
    ("P003", "Finance Manager", "Mr. Chandran", "Finance", "P001", "Filled", "finance@example.org", "9800000003", 2),
    ("P004", "HR Manager", "", "HR", "P001", "Vacant", "", "", 3),
    ("P005", "IT Manager", "Mr. Deepak Nair", "IT", "P001", "Filled", "", "", 4),
    ("P006", "Administrative Officer", "Ms. Elsa Paul", "Administration", "P002", "Filled", "", "", 1),
    ("P007", "Accountant", "Ms. Fathima", "Finance", "P003", "Filled", "", "", 1),
    ("P008", "Audit Officer", "Mr. George", "Finance", "P003", "Filled", "", "", 2),
    ("P009", "Cashier", "Mr. Hari", "Finance", "P007", "Filled", "", "", 1),
    ("P010", "HR Assistant", "Ms. Indu", "HR", "P004", "Filled", "", "", 1),
    ("P011", "System Administrator", "Mr. Jose", "IT", "P005", "Filled", "", "", 1),
    ("P012", "Web Developer", "", "IT", "P005", "Vacant", "", "", 2),
    ("P013", "Office Assistant", "Ms. Latha", "Administration", "P006", "Filled", "", "", 1),
]
extras = [
...
lines = [
    ...
    ("Cells to edit", "Positions: columns A to I.  Extra_Reporting: columns A to C.  Column J of Positions is filled automatically - do not type there."),
    ("", None),
    ...
    ("name", "Person holding the post. Leave blank if vacant."),
    ("department", "Used for colours and grouping in the chart."),
    ...
    ("status", "Filled or Vacant (choose from the dropdown). Vacant posts are highlighted."),
...
wp["J1"].fill = PatternFill("solid", start_color="7F7F7F")
...
for r in range(2, 301):
    for c in range(1, 10):
        ...
        cell.border = BORDER
    j = wp.cell(row=r, column=10,
                value=f'=IF(E{r}="","",IFERROR(INDEX($B$2:$B${LAST},MATCH(E{r},$A$2:$A${LAST},0)),"NOT FOUND"))')
...
dv_order.add(f"I2:I{LAST}")

wp["E1"].comment = Comment("Leave blank for top-level (Level 1) posts. Otherwise pick the position_id of the main manager.", "Template")
